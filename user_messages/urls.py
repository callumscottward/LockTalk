...
from .import views
from .views import ConversationListView, MessageListView, MessageCreateView, AddMemberView, RemoveMemberView, MyConversationKeyView, get_current_user, all_conversations_directory, all_users_list
...
urlpatterns = [
    ...
    path("api/conversations/<uuid:conversation_id>/my-key/", MyConversationKeyView.as_view()),
